...
from sesemi.models.loss_heads.rotation_prediction import RotationPredictionLossHead
...
def test_rotation_prediction_loss_head(
    ...
    loss_head = RotationPredictionLossHead(data=data, backbone=backbone)
